				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-edit"></i> Advertisements
							</li>
						</ol>
					</div>
				</div>
								...
								<tbody>
									<c:forEach items="${products}" var="product">
										<tr>
											...
											<td><a href="http://www.ecommerece.com:8080/products" target="_blank" class="button btn btn-primary">Buy</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
